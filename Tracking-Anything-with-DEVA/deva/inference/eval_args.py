...
def add_common_eval_args(parser: ArgumentParser):
    parser.add_argument('--DEVA_model', default='/home/hjz/EVT/Offline_RL_Active_Tracking/Tracking-Anything-with-DEVA/saves/DEVA-propagation.pth')
...
def get_model_and_config(parser: ArgumentParser):
    ...
    if args.DEVA_model is not None:
        model_weights = torch.load(args.DEVA_model)
